...
Its one real neighbour is [handoff](https://aihero.dev/skills-handoff). If a grilling session exposes something you do not understand, do not derail the original workspace. Use `/handoff` to open a teaching workspace, learn it there with `/teach`, then return and continue the original thread. The nearby alternative is [research](https://aihero.dev/skills-research), for when you need a cited document rather than lessons and retention. When you are not sure which skill or flow fits, [ask-matt](https://aihero.dev/skills-ask-matt) routes you over the whole set.
