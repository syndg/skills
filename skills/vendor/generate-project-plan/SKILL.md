...
**Tools / refs loaded**
- `use_figma` (one call).
- Re-load the `figma-use-figjam` skill.
...
**Tools / refs loaded**
- Re-load the `figma-generate-diagram` skill before each `generate_diagram` call.
- Re-load the `figma-use-figjam` skill + `blocks/diagram-section.md` before each reparent `use_figma` call.
