...
- **"Does this logic / state model feel right?"** → [LOGIC.md](LOGIC.md). Build one self-contained HTML/CSS/JS demo that a non-developer can open directly, use to drive the state model, and share without installing anything.
